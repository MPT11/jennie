...
<head>
    ...
    <script type="text/javascript" src="/jennie/resources/js/jennie/reboard.js"></script>
    <style type="text/css">
        .w3-button {
            padding: 1px 16px;
        }
...
<div class="w3-content mxw750 w3-margin-top">
    ...
    <header class="w3-col w3-card-4 mgb20">
        <h1 class="w3-pink w3-center w3-padding mg0">Jennie 댓글 게시글 작성</h1>
        ...
        <div class="w3-col w3-round-large w3-card-4 w3-margin-bottom w3-padding">
            ...
            <div class="w3-rest w3-padding">
                <div class="w3-col w3-border-bottom">
                    <span class="w3-third w3-left mgb10 ft10"><small>글내용</small></span>
                </div>
                <form method="POST" action="/jennie/reboard/reboardWriteProc.blp" id="frm" name="frm" class="w3-col w3-margin-top">
