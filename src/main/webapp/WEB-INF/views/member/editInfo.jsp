...
<head>
    ...
    <script type="text/javascript" src="/jennie/resources/js/jennie/edit.js"></script>
    <style type="text/css">
        .avtimg {
            width: 100px;
            height: 100px;
...
<div class="w3-content w3-margin-top mxw700">
    <!-- 타이틀 -->
    <h1 class="w3-pink w3-center w3-padding w3-card-4">${DATA.name} 회원 정보수정</h1>
    <form method="POST" action="" name="frm" id="frm"
        ...
        <div>
            ...
            <h4 type="text" name="name" id="name" class="w3-center w3-col s8 w3-margin-top ft14 mgb10">${DATA.name}</h4>
        </div>
        <div>
            <label for="id" class="w3-col s3 w3-right-align clrgrey ft14 mgb10">아 이 디 : </label>
            <h4 type="text" name="id" id="id" class="w3-center w3-col s8 ft14 mgb10">${DATA.id}</h4>
        </div>
        <div>
        ...
        <div>
            ...
            <h4 class="w3-col s8 mgl10 mgb10 w3-center">${((DATA.gen == 'M') ? '남자' : '여자')}</h4>
        </div>
                        ...
                        <c:if test="${data.gen eq DATA.gen}">
                            <div class="avtbox">
                                <label for="avt${data.ano}">
                                    <img src="/jennie/resources/img/avatar/${data.savename}" class="w3-col avtimg">
                                </label>
